...
# Lead schema for chimney cleaning website
class Lead(BaseModel):
    """
    Leads from the website contact/quote form
    ...
    message: Optional[str] = Field(None, description="Additional details or issues")
